...
<div class="breadcrumb">
    <a href="<?php echo home_url(); ?>">Trang chủ</a> > <span>Kết quả tìm kiếm cho: "<?php echo get_search_query(); ?>"</span>
</div>
<!-- Banner -->
<div class="banner">
...
<div class="search-banner">
    <div class="banner-content">
        ...
        <p>Tìm thấy <?php global $wp_query;
                    echo $wp_query->found_posts; ?> kết quả cho từ khóa "<?php echo get_search_query(); ?>"</p>
    </div>
</div>
...
.search-filters.container {
    ...
    flex-wrap: wrap; /* Đảm bảo rằng các bộ lọc xuống hàng nếu không đủ không gian */
    margin-bottom: 20px; /* Khoảng cách dưới cùng */
}

.filter-options {
    flex: 1; /* Căn đều các bộ lọc */
    min-width: 150px; /* Đặt kích thước tối thiểu để không bị quá nhỏ */
}

select {
    width: 100%; /* Đặt chiều rộng của select để vừa với container */
    padding: 8px;
